...
import {ChevronDoubleUpIcon,MagnifyingGlassIcon} from '@heroicons/react/24/outline'
import { RoutineDetails } from '../../Components/RoutineDetails'

function Routines(){
    const {
        showRoutineDetails,searchByName,setSearchByName,setFilterBy,filterBy,filteredRoutines,availableCategories,setSearchByCategory,setExecuteFilters,equipmentOptions,setSearchByEquipment,
        setMinHrs,
        minHrs,
        setMinMinutes,
        minMinutes,
